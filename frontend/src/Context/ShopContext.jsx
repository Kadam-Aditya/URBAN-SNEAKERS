...
const ShopContextProvider = (props) => {
  ...
  const getTotalCartItemsId = () => {
    // This will hold the array of items with their quantities
    ...
    for (const itemId in cartItems) {
      ...
      if (quantity > 0) {
        try {
          ...
          // Add the item info with its quantity to the array
          if (itemInfo) {
  ...
  const contextValue = { products, getTotalCartItems, cartItems, addToCart, removeFromCart, getTotalCartAmount, getTotalCartItemsId };
  return (
